...
VALUES
    ...
    (7, NOW(), NOW(), NULL, NULL, NULL, NULL, NULL, 'DIRECT', NULL, NULL, NOW() + INTERVAL 15 DAY, NOW() + INTERVAL 7 DAY, NULL, 'DIRECT', NULL, 'PENDING_APPROVAL', 2, 7),

    -- 동시성 테스트를 위해 다른 게스트가 한 게시물에 대해 같은 기간으로 예약 등록
    (8, NOW(), NOW(), NULL, NULL, NULL, NULL, NULL, 'DIRECT', NULL, NULL, NOW() + INTERVAL 61 DAY, NOW() + INTERVAL 60 DAY, NULL, 'DIRECT', NULL, 'PENDING_APPROVAL', 2, 7),
    (9, NOW(), NOW(), NULL, NULL, NULL, NULL, NULL, 'DIRECT', NULL, NULL, NOW() + INTERVAL 61 DAY, NOW() + INTERVAL 60 DAY, NULL, 'DIRECT', NULL, 'PENDING_APPROVAL', 3, 7);
