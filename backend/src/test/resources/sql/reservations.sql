...
VALUES
    ...
    (8, NOW(), NOW(), NULL, NULL, NULL, NULL, NULL, 'DIRECT', NULL, NULL, NOW() + INTERVAL 60 DAY, NOW() + INTERVAL 61 DAY, NULL, 'DIRECT', NULL, 'PENDING_APPROVAL', 2, 1),
    (9, NOW(), NOW(), NULL, NULL, NULL, NULL, NULL, 'DIRECT', NULL, NULL, NOW() + INTERVAL 60 DAY, NOW() + INTERVAL 61 DAY, NULL, 'DIRECT', NULL, 'PENDING_APPROVAL', 3, 1);
