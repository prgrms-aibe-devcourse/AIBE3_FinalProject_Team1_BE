...
VALUES
    ...
    -- 멤버 3이 예약한 멤버 1 Post (Post ID: 1,2,3)
    (7, NOW(), NOW(), NULL, NULL, '서울특별시 서초구', '반포동', 'CJ대한통운', 'DELIVERY', 'TRK300001', NULL, NOW() + INTERVAL 7 DAY, NOW() + INTERVAL 4 DAY, 'CJ대한통운', 'DELIVERY', 'TRK300002', 'PENDING_APPROVAL', 3, 1);