...
VALUES
    ...
    -- 멤버 2가 예약한 멤버 1 Post (Post ID: 2,3)
    (4, NOW(), NOW(), NULL, NULL, '경기도 성남시', '분당동', 'CJ대한통운', 'DELIVERY', 'TRK200001', NULL, NOW() + INTERVAL 15 DAY, NOW() + INTERVAL 12 DAY, 'CJ대한통운', 'DELIVERY', 'TRK200002', 'RETURN_COMPLETED', 2, 2),
    ...
    (7, NOW(), NOW(), NULL, NULL, '경기도 성남시', '분당동', NULL, 'DELIVERY', NULL, NULL, NOW() + INTERVAL 15 DAY, NOW() + INTERVAL 7 DAY, NULL, 'DELIVERY', NULL, 'PENDING_APPROVAL', 2, 7),

    -- 동시성 테스트를 위해 다른 게스트가 한 게시물에 대해 같은 기간으로 예약 등록
    (8, NOW(), NOW(), NULL, NULL, '경기도 성남시', '분당동', NULL, 'DELIVERY', NULL, NULL, NOW() + INTERVAL 61 DAY, NOW() + INTERVAL 60 DAY, NULL, 'DELIVERY', NULL, 'PENDING_APPROVAL', 2, 7),
    (9, NOW(), NOW(), NULL, NULL, '경기도 성남시', '분당동', NULL, 'DELIVERY', NULL, NULL, NOW() + INTERVAL 61 DAY, NOW() + INTERVAL 60 DAY, NULL, 'DELIVERY', NULL, 'PENDING_APPROVAL', 3, 7);
